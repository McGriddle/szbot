...
class Insult(commands.Cog):
    ...
    @commands.command(help='Insult someone ex. :insult @geraldwhite')
    async def insult(self, ctx, user: discord.User = None):
        ...
        if user:
                if user == self.bot.user:
                    bot_msg = ["How original. No one else had thought of trying to get the bot to insult itself. I applaud your creativity. Yawn. Perhaps this is why you don't have friends. You don't add anything new to any conversation. You are more of a bot than me, predictable answers, and absolutely dull to have an actual conversation with.",
                               "https://i.giphy.com/soFDqwoP0I6M8.gif",
                               "https://i.giphy.com/GMvRQPtcwpLMI.gif",
                               "https://i.imgur.com/Y9ThPqn.gif"]
