...
from chatformatting import pagify
...
class Imgflip(commands.Cog):
    ...
    def __init__(self, bot):
        self.bot = bot
        self.username = loadconfig.__imgflip_username__
        self.password = loadconfig.__imgflip_password__
    ...
    async def meme(self, ctx: commands.Context, meme: Meme, *, text: str) -> None:
        ...
        try:
            url = await self.get_meme(meme[0], boxes, self.username, self.password)
        except Exception:
